...
export default function PremiumPackageSection({ isRTL }) {
  ...
  const packages = t("omra.premium.packages", { returnObjects: true });
        ...
        >
          <div className="col-lg-10">
            ...
            >
              ...
              <span>{t("omra.premium.badge")}</span>
            </div>
            ...
            >
              ...
              <span>{t("omra.premium.duration")}</span>
            </div>
          </div>
        </div>
